...
public class AuthService {
    ...
    public TokenResponseDTO login(LoginDTO loginDTO) {
        ...
        tokenResponseDto.setProfileUrl(member.getImageUrl());
    ...
    public TokenResponseDTO reissue(TokenRequestDTO tokenRequestDto) {
        ...
        // 6. 토큰 발급
        TokenResponseDTO tokenResponseDTO = tokenProvider.generateAccessTokenDto(authentication, tokenRequestDto);
